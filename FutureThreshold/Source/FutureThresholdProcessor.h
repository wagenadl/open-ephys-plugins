...
#ifndef FUTURETHRESHOLDPROCESSOR_H_INCLUDED
#define FUTURETHRESHOLDPROCESSOR_H_INCLUDED
...
*/
class FutureThresholdProcessor : public GenericProcessor

{
public:
  enum {
    PARAM_INPUT_CHANNEL = 0,
    PARAM_OUTPUT_CHANNEL,
    PARAM_TRIGGER_THRESHOLD,
    PARAM_RESET_THRESHOLD,
    PARAM_DELAY_SAMPS,
  };
public:
    /** The class constructor, used to initialize any members. */
    FutureThresholdProcessor();
  ...
  void prepareToPlay(double fs_hz, int estspb) override;
...
private:
  ...
  EventChannel *eventChannelPtr;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (FutureThresholdProcessor);
};


#endif  // FUTURETHRESHOLDPROCESSOR_H_INCLUDED
