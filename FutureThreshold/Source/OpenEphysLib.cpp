...
extern "C" EXPORT void getLibInfo (Plugin::LibraryInfo* info)
{
    ...
    info->name = "FutureThreshold plugin library";
...
extern "C" EXPORT int getPluginInfo (int index, Plugin::PluginInfo* info)
{
    switch (index)
    {
        ...
        case 0:
            ...
            //For processor
            info->processor.name = "FutureThreshold"; //Processor name shown in the GUI
            ...
            info->processor.creator = &(Plugin::createProcessor<FutureThresholdProcessor>);
        break;
        /**
