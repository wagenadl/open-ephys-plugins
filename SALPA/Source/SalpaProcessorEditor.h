...
#ifndef SALPAPROCESSOREDITOR_H_INCLUDED
#define SALPAPROCESSOREDITOR_H_INCLUDED
...
*/
class SalpaProcessorEditor : public VisualizerEditor
{
public:
...
#endif // SALPAPROCESSOREDITOR_H_INCLUDED
