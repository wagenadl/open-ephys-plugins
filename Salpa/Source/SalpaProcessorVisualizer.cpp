...
SalpaProcessorVisualizer::SalpaProcessorVisualizer (SalpaProcessor* procesor)
{
...
void SalpaProcessorVisualizer::setParameter (int parameter, int val1, int val2, float newValue)
{
}
