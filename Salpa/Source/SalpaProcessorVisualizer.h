...
#ifndef SALPAPROCESSORVISUALIZER_H_INCLUDED
#define SALPAPROCESSORVISUALIZER_H_INCLUDED
...
*/
class SalpaProcessorVisualizer : public Visualizer
{
public:
    /** The class constructor, used to initialize any members. */
    SalpaProcessorVisualizer (SalpaProcessor* processor);

    /** The class destructor, used to deallocate memory */
    ~SalpaProcessorVisualizer();
...
#endif // SALPAPROCESSORVISUALIZER_H_INCLUDED
